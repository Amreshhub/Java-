...
class pr extends Frame implements ItemListener,ActionListener
{
...
{	
	...
	rb2=new Checkbox("Femal",cbg1,false);
	...
	cmb1.addItem("Matirc");
	cmb1.addItem("Inter");
	cmb1.addItem("Geratiaion");
	
	cmb2.addItem("KATIHAR");
	cmb2.addItem("PATNA");
	cmb2.addItem("HAJIPUR");
	setLayout(null);
...
{  
	...
	//{
	//	name[i]=(t1.getState());
//		fee[i]=Float.valueOf(t3.getState());
	//	roll[i]=Integer.ParseInt(t2.getState());
	//	city[i]=(t4.getState());
		  //    i++;
		//if(i==5)
	///	b1.getState(false);
